...
const UUID = process.env.UUID || '9afi1229-b893-40c1-84dd-51e7ce204913'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'agent.xn--8uqu92f.top:80';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'tOS0hKyaFrXvyfCM9eipE7gN6QFQakoQ';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
